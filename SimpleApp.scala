...
object SimpleApp {
  def main(args: Array[String]) {
    ...
    val googleAnalyticsData = spark.read.json("/Users/priyadarshanp/Documents/DEBootCamp/files/*.gz");
    ...
    val numberOfUsers = spark.sql("Select count(distinct userId) from analyticsView").show()
